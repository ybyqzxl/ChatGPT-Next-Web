...
const it: LocaleType = {
    ...
    Home: {
        NewChat: 'Nuova Chat',
        DeleteChat:
            'Confermare la cancellazione della conversazione selezionata?',
    ...
    Settings: {
        ...
        FontSize: {
            ...
            SubTitle:
                'Regolare la dimensione dei caratteri del contenuto della chat',
        },
        SendKey: 'Tasto invia',
        Theme: 'Tema',
        ...
        MaxTokens: {
            Title: 'Token massimi',
            SubTitle:
                'Lunghezza massima dei token in ingresso e dei token generati',
        },
        PresencePenlty: {
