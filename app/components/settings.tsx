    ...
    return (
        <ListItem>
            <div className={styles['settings-title']}>
                <div>{props.title}</div>
                {props.subTitle && (
                    <div className={styles['settings-sub-title']}>
                        {props.subTitle}
                    </div>
                )}
            </div>
...
export function Settings(props: { closeSettings: () => void }) {
    ...
    console.error('[AAAAAAA]Panda showUsage', showUsage);
    useEffect(() => {
        ...
        <ErrorBoundary>
            ...
            <div className={styles.settings}>
                    ...
                    <ListItem>
                        ...
                        <select
                            ...
                            onChange={(e) => {
                                updateConfig(
                                    (config) =>
                                        (config.theme = e.target
                                            .value as any as Theme),
                                );
                            }}
                        >
                    ...
                    {enabledAccessControl ? (
                        ...
                        >
                            <PasswordInput
                                ...
                                type="text"
                                placeholder={
                                    Locale.Settings.AccessCode.Placeholder
                                }
                                onChange={(e) => {
                ...
                <List>
                    ...
                    >
                        <InputRange
                            value={config.modelConfig.presence_penalty?.toFixed(
                                1,
                            )}
                            min="-2"
                            max="2"
