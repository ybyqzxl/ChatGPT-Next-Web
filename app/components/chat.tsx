                    ...
                    <Modal
                        ...
                        actions={[
                            ...
                            <IconButton
                                ...
                                onClick={() =>
                                    copyToClipboard(session.memoryPrompt)
                                }
                            />,
                        ]}
                    >
                        <>
                            <div className={chatStyle['context-prompt']}>
                                ...
                                >
                                    <IconButton
                                        ...
                                        bordered
                                        className={
                                            chatStyle['context-prompt-button']
                                        }
                                        onClick={() =>
                                            addContextPrompt({
                                                role: 'system',
                            ...
                            <div className={chatStyle['memory-prompt']}>
                                <div
                                    className={chatStyle['memory-prompt-title']}
                                >
                                    <span>
                                        {Locale.Memory.Title} (
                                        {session.lastSummarizeIndex} of{' '}
                                        {session.messages.length})
                                    </span>

                                    <label
                                        className={
                                            chatStyle['memory-prompt-action']
                                        }
                                    >
                                        {Locale.Memory.Send}
                                        <input
                                ...
                                <div
                                    className={
                                        chatStyle['memory-prompt-content']
                                    }
                                >
...
export function Chat(props: {
    ...
    const onChatBodyScroll = (e: HTMLElement) => {
        const isTouchBottom =
            e.scrollTop + e.clientHeight >= e.scrollHeight - 20;
    ...
    const onInput = (text: string) => {
        ...
        if (n === 0) {
            ...
            !chatStore.config.disablePromptHint &&
            n < SEARCH_TEXT_LIMIT
        ) {
        ...
        <div className={styles.chat} key={session.id}>
            <div className={styles['window-header']}>
                ...
                <div className={styles['window-actions']}>
                    <div
                        className={
                            styles['window-action-button'] + ' ' + styles.mobile
                        }
                    >
                        <IconButton
                            icon={<ReturnIcon />}
